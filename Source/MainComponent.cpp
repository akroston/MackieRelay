...

{
    ...
    midiInputList.addItemList(midiOutputs, 1);
    ...
    if (index >= 0)
    {
        midiOut_ = MidiOutput::openDevice(index);
         ...
         throw std::invalid_argument( "no output devices found" );
    }
...
void MainContentComponent::relayMessage(const MidiMessage &message){
